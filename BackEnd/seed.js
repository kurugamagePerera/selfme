...
mongoose
  .connect(
    /*'mongodb+srv://admin:MlRO4Wr0yQyWjAfB@cluster0.imz0nqj.mongodb.net/inventoryDBs'*/
    ...
    try {
      ...
      const employees = await Employee.insertMany([
        ...
        },
        {
          ...
          Employee_Dob: new Date('1992-05-15'),
      ...
      await PurchaseOrder.insertMany([
        {
          ...
          assigned_employee: employees[0]._id,
          assigned_date: new Date(),
          deadline: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000),
        },
        {
          custom_id: 'PO-20250923-002',
          customerId: 'CUST002',
          ...
          status: 'Done',
          paid: true,
          order_date: new Date('2025-09-02'),
          assigned_employee: employees[1]._id,
          assigned_date: new Date(),
          deadline: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000),
        },
        {
          custom_id: 'PO-20250923-003',
          customerId: 'CUST003',
          ...
          status: 'Pending',
          paid: true,
          order_date: new Date('2025-09-03'),
          assigned_employee: null,
        },
        {
          custom_id: 'PO-20250923-004',
          customerId: 'CUST004',
          ...
          status: 'Done',
          paid: true,
          order_date: new Date('2025-09-04'),
          assigned_employee: employees[0]._id,
        },
        {
          custom_id: 'PO-20250923-005',
          customerId: 'CUST005',
          customerName: 'Epsilon Firm',
          product: 'Solar Kit',
          total_amount: 250000,
          status: 'Pending',
          paid: false,
          order_date: new Date('2025-09-05'),
          assigned_employee: employees[1]._id,
        },
      ]);
      ...
      await JobReport.insertMany([
        {
          job_id: 'PO-20250923-002',
          job_type: 'PurchaseOrder',
          technician_id: employees[1]._id,
          report_details: 'Installation completed successfully',
          rating: 5,
          comments: 'Client satisfied',
        },
        {
          job_id: 'PO-20250923-004',
          job_type: 'PurchaseOrder',
          technician_id: employees[0]._id,
          report_details: 'System upgraded',
          rating: 4,
          comments: 'Minor delay',
        },
      ]);
